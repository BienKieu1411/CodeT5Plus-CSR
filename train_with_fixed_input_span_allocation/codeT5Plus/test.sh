MODEL="BienKieu/codeT5Plus"
DATA_DIR="../../data"
BASE_OUTPUT="../../results/train_with_fixed_input_span_allocation/codeT5Plus"

# Chọn 1 trong 4 kiểu rerank:
# none / textrank / cross-encoder / hybrid
RERANK_METHOD="cross-encoder"    # ← Đổi chỗ này để test từng loại
